      ...
      <div className={cn("container mx-auto px-6 py-4 flex items-center justify-between")}  >
        ...
        <div className="flex items-center gap-2.5">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a
              href={appUrls.pos}
              className="text-accent-foreground hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors"
            >
              Sign in
            </a>
                ...
                <nav className="flex flex-col space-y-4 mt-6">
                  ...
                  <div className="pt-4 space-y-2">
                    <Button variant="outline" className="w-full" asChild>
                      <a href={appUrls.pos}>Sign in</a>
                    </Button>
                    <RainbowButton className="w-full" onClick={() => setIsOpen(false)} asChild>
                      <Link href="/signup">Start free trial</Link>
                    </RainbowButton>
                  </div>
                </nav>
