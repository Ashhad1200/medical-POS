...
const Hero = () => {
  ...
  const rotatingWords = ["Pharmacies", "Clinics", "Chemists"];
    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-5xl mx-auto">
          ...
          >
            Batch-aware inventory, fast counter checkout, purchase orders and
            AI analytics — everything a medical store needs, in one place.
          </motion.p>
