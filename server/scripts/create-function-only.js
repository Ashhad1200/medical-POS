...
const functionSQL = `
-- Function to receive purchase order items and update inventory
...
BEGIN
    ...
    LOOP
        ...
        SET 
            ...
            updated_at = NOW()
        WHERE id = (
            SELECT medicine_id FROM purchase_order_items 
            WHERE id = (item->>'id')::UUID
        );
...
async function createFunctionViaExecSQL() {
  try {
    console.log('🔧 Creating receive_purchase_order_items function via exec_sql...');
