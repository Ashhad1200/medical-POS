...
const getAllSuppliers = asyncHandler(async (req, res) => {
  ...
  const result = await RefactoredSupplier.findByOrganization(organizationId, options);
...
const getSuppliersByCity = asyncHandler(async (req, res) => {
  ...
  const cityStats = data.reduce((acc, supplier) => {
  ...
  res.json(createSuccessResponse(
    cities,
    'Supplier cities fetched successfully'
  ));
});
